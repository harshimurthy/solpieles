...
@if ($drivers->birthdaysThisMonth->count() > 0)
	<h1 class="text-center text-info">
		Las Siguientes Personas Cumplen Años En El Mes de {{ date("M", strtotime("today")) }}
	</h1>
	<table class="table table-condensed table-hover">
		...
		<tbody>
			@foreach ($drivers->birthdaysThisMonth as $driver)
				<tr>
...
@else
	<h1 class="text-center text-warning">
		Noy hay choferes que cumplan años {{ date("M", strtotime("today")) }}!
	</h1>
@endif		        	