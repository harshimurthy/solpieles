@if ($drivers->birthdaysToday->count() > 0)
	<h1 class="text-center text-info">
		Las Siguientes Personas Cumplen Años En El Día de Hoy
	</h1>	
	<table class="table table-condensed table-hover">
		...
		<tbody>
			@foreach ($drivers->birthdaysToday as $driver)
				<tr>
...
@else
	<h1 class="text-center text-warning">
		Noy hay choferes que cumplan años hoy!
	</h1>
@endif
